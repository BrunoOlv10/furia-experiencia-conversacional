...
MENU_OPTIONS = emoji.emojize(
    ...
    ":keycap_6: - Criadoras de conteúdo e Streamers"
)
...
INITIAL_MESSAGE = emoji.emojize(
    f":paw_prints: Fala, guerreiro(a)! Quer ficar por dentro de tudo da FURIA? Digite um número:\n{MENU_OPTIONS}"
)
    ...
    try:
        while True:
            ...
            if primeira_interacao:
                ...
                await websocket.send_text(MENU_MESSAGE)
                ...
                await websocket.send_text(emoji.emojize(":shopping_cart: Lojinha da pantera: https://www.furia.gg"))
                await websocket.send_text(MENU_MESSAGE)
